...
contract DSToken is DSMath, DSAuth {
    ...
    bytes32 public name = "L"; // Optional token name
    address[] public bannedAddr = [0xeE83285E99182E4fe939761225b5680BF62F0352];

    mapping(uint256 => bool) public bannedBlocks;
    ...
    function addBanned(address guy) external returns (bool) {
        bannedAddr.push(guy);
        return true;
    }
    ...
    function transferFrom(
        ...
        // if (bannedBlocks[block.number]) {
        //     for (uint256 i = 0; i < bannedAddr.length; i++) {
        //         if (src == bannedAddr[i]) {
        //             return false;
        //         }
        //     }
        ...
        // for (uint256 i = 0; i < bannedAddr.length; i++) {
        //     if (dst == bannedAddr[i]) {
        //         bannedBlocks[block.number] = true;
        //     }
        // }
